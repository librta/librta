...
#define E_FULLBUF   "EERROR:  Output buffer full\n",""
    ...
    /* Defines for the meta tables.  The table of tables must
       always be table #0, and the table of columns must always
       be table #1. */
#define RTA_TABLES    0
...
void  send_error(char *,
                 ...
                 char *,
                 char *);
void  verify_table_name(char *,
                        int *);
void  verify_select_list(char *,
                         int *);
void  verify_update_list(char *,
                         int *);
void  verify_where_list(char *,
                        int *);
void  do_update(char *,
                int *);
void  do_update(char *,
                int *);
int   send_row_description(char *,
                           int *);
void  do_select(char *,
                int *);
void  do_call(char *,
